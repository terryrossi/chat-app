...
const Start = ({ navigation }) => {
	...
	// Firestore Anonymous Authorization
	const auth = getAuth();
		...
		signInAnonymously(auth)
			.then((result) => {
				navigation.navigate('Chat', {
					userId: result.user.uid, // User Id Generated by Firestore
					name: name, // Name Entered by the User
					backgroundColor: backgroundColor, // BackGround Color Selected by the user
				});
				Alert.alert('Signed in Successfully!');
			})
			.catch((error) => {
				Alert.alert('Unable to sign in, try later again.'); // Usually due to Bad Internet Connection
			});
	};
